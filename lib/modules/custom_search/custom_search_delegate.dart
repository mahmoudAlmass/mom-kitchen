...
class CustomSearchDelegate extends SearchDelegate {
  ...
  final Stream<List<Meal>>? data;
  final Stream<List<String>>? searchQueries;
  CustomSearchDelegate({this.data,this.searchQueries});
...
return StreamBuilder<List<Meal>>(
      ...
      builder: (context,AsyncSnapshot<List<Meal>>snapshot){
          ...
          final result= snapshot.data!.where((element) => element.title!.toLowerCase().contains(query.toLowerCase()));
          Provider.of<AppProvider>(context,listen: false).storeSearchQuery(query.toString());
          return ListView(
            children: 
              result.map<Card>((a) =>
                Card(
